        ...
        $.advancedHero.slides = [
            {
                ...
                "slideImage":"/etc/designs/aemworkshop/img/hero/hero-ibm-partner-lg.jpg",
                "content":"This is the main text that show on the slide (slide 2)",
                "contentBgColor":"green",
                "caption":"<a href='#'><img src='/etc/designs/aemworkshop/img/adesa-logo.png'><strong>TEST 2:</strong> Another test caption</a>",
                "buttonText":"Action",
                "buttonActionURL":"http://www.perficient.com"
            },
            {
                "heading":"The Connected Enterprise",
                "slideImage":"/etc/designs/aemworkshop/img/hero/hero-lifescience-lg.jpg",
                "content":"This is the main text that show on the slide (slide 3)",
                "contentBgColor":"blue",
                "caption":"<a href='#'><img src='/etc/designs/aemworkshop/img/adesa-logo.png'><strong>TEST 3:</strong> Yet Another test caption</a>",
                "buttonText":"Action",
                "buttonActionURL":"http://www.perficient.com"
            },
            {
                "heading":"A Story Of Scalability & Success",
                "slideImage":"/etc/designs/aemworkshop/img/hero/hero-services-detail-lg.jpg",
                "content":"This is the main text that show on the slide (slide 4)",
                "contentBgColor":"silver",
                "caption":"<a href='#'><img src='/etc/designs/aemworkshop/img/adesa-logo.png'><strong>TEST 4:</strong> Here is a longer test caption</a>",
                "buttonText":"Action",
                "buttonActionURL":"http://www.perficient.com"
            }
        ];
